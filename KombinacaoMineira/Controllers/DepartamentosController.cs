...
namespace KombinacaoMineira.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(KombinacaoMineiraContext context)
        {
            _context = context;
        }
        ...
        public IActionResult ConfirmarDelecao(int id)
        {
            ...
            {
                return RedirectToAction(nameof(Error), new { message = "Departamento possui Vendedor cadastrados. Não é possível deletar o departamento" });
            }
